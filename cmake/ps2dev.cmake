...
# Copyright (C) 2024-2026 PS2DEV Team
# Copyright (C) 2026-Present Aquiles Trindade <trindadedev13@gmail.com>
#
...
find_program(CMAKE_C_COMPILER   mips64r5900el-ps2-elf-gcc    REQUIRED)
find_program(CMAKE_CXX_COMPILER mips64r5900el-ps2-elf-g++    REQUIRED)
find_program(CMAKE_ASM_COMPILER mips64r5900el-ps2-elf-gcc    REQUIRED)
find_program(CMAKE_AR           mips64r5900el-ps2-elf-ar     REQUIRED)
find_program(CMAKE_RANLIB       mips64r5900el-ps2-elf-ranlib REQUIRED)
find_program(CMAKE_STRIP        mips64r5900el-ps2-elf-strip  REQUIRED)
